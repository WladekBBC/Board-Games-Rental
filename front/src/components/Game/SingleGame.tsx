    ...
    <>
      <div
        ...
        className={`bg-white dark:bg-gray-800 rounded-lg ${
          displayFullDescription ? "" : "shadow-md"
      ...
      >
        ...
        <div className="p-4">
          ...
          <div className="mt-2 mb-2 text-sm text-gray-600 dark:text-gray-300 min-h-[3em]">
            {displayFullDescription ||
            game.description.length <= descriptionMaxLength
              ? game.description
          ...
          <div className="inline-flex flex-wrap w-full">
            <span className="mt-4 p-1 ml-1 mr-1 text-sm border-2 rounded-md border-gray-500 text-gray-500 dark:text-gray-400 dark:border-gray-400">
              {game.category}
            </span>
            {game.ages && (
              <span className="ml-1 mr-1 mt-4 p-1 text-sm border-2 rounded-md border-gray-500 text-gray-500 dark:text-gray-400 dark:border-gray-400">
                {game.ages}
              </span>
            )}
            {game.players && (
